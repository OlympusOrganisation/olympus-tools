...
module.exports = {
  ...
  logSuccess: function(message, type) {
    type = type || "info";
    var chr = isWindows ? "+" : "✔";
    console.log(clc.green(chr + " "), message);
  },
  /**
   * Log an info statement with a green checkmark at the start of the line.
  ...
  logLabeledSuccess: function(label, message, type) {
    type = type || "info";
    var chr = isWindows ? "+" : "✔";
    console.log(clc.green(chr + "  " + label + ":"), message);
  },
  /**
  ...
  logBullet: function(message, type) {
    type = type || "info";
    console.log(clc.cyan.bold("i "), message);
  },
  /**
   * Log an info statement with a gray bullet at the start of the line.
   * @param {String} label The label for the message
  ...
  logLabeledBullet: function(label, message, type) {
    type = type || "info";
    console.log(clc.cyan.bold("i  " + label + ":"), message);
  },
  /**
   * Log an info statement with a gray bullet at the start of the line.
   * @param {String} The message to log
  ...
  logWarning: function(message, type) {
    type = type || "warn";
    var chr = isWindows ? "!" : "⚠";
    console.log(clc.yellow.bold(chr + " "), message);
  },
  /**
  ...
  explainStdin: function() {
    ...
    if (process.stdin.isTTY) {
      console.log(clc.bold("Note:"), "Reading STDIN. Type JSON data and then press Ctrl-D");
    }
  },
  /**
