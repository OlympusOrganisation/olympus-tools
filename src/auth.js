...
// TODO: Remove Scopes
var scopes = null; //require("./scopes");
...
var _refreshAccessToken = function(refreshToken, authScopes) {
  console.log("> refreshing access token with scopes:", JSON.stringify(authScopes));
  return api
...
var getAccessToken = function(refreshToken, authScopes) {
  //console.log("_haveValidAccessToken " + _refreshAccessToken(refreshToken, authScopes));
